...
/*    Provider.of<UserDetailsProvider>(context).getUserData();
   ...
   //I can define and use this in my Obx widget too but i could not sure which one is better to use.
...
/*    return Consumer<IsProfileCreatedProvider>(
                    ...
                    children: [
                      ...
                      Stack(
                        ...
                        children: [
                          CircleAvatar(
                            radius: sh /
                                16, // Set a fixed radius for the CircleAvatar
                      ...
                      littleSpace,
                      Obx(() {
                        final userDetailsValue = userDetailsController.userDetails.value;
                        return Column(
                          children: [
                            ///Name Surname
                            MyTextFieldWidget(
                              ...
                              children: [
                                GenderBoxesWidget(
                                  controller: isProfileCreated
                                      ? userDetailsValue != null
                                      ? ValueNotifier<bool>(
                                      userDetailsValue.gender ?? true)
                                      : ValueNotifier<bool>(
                                ...
                                child: MainButtonWidget(
                                  onPressed: () async {
                                    await onPressedSaveButton(
                                        isProfileCreated, userDetailsValue!);
                                  },
                                  haveRadius: true,
    ...
    return Obx(() {
      final bool isProfileCreated = isProfileCreatedController.isProfileCreated.value;
      return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBarWidget(
        haveStringTitle: true,
                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: MainButtonWidget(
                                onPressed: () async {
                                  await onPressedSaveButton(
                                      isProfileCreated, userDetailsValue!, isProfileCreatedController);
                                },
                                haveRadius: true,
                                child: const Text("Save"),
                              ))
  ...
  Future<void Function()?> onPressedSaveButton(
      bool isProfileCreated, UserDetailsModel userDetails,IsProfileCreatedController isProfileCreatedController) async {
    ...
    if (!isProfileCreated) {
      if (nameController.text.isNotEmpty &&
        ...
        await checkConditionsAndRun(age, output, isProfileCreated, userDetails, isProfileCreatedController);
      } else {
  ...
  Future<void> checkConditionsAndRun(int age, String output,
    ...
    if (!isProfileCreated) {
      ...
      if (age < 18) {
        ...
        if (!mounted) return;
      //  Provider.of<IsProfileCreatedProvider>(context, listen: false).updateIsProfileCreated(true);
